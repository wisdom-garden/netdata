...
mod = loader.load_module_from_file("frame_loss", PYTHON_MODULES_DIR + '/' + 'frame_loss.chart.py')[0]
...
if __name__ == '__main__':
    ...
    config = {
        'job_name': 'frame_loss',
        'timeout': 10,
        "override_name": "frame_loss",
        'url': 'http://94217661.ngrok.io/d/detect-video-sync'
    }
